              ...
              <div className="ecological-2 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                ...
                <div className="ecological-body">
                  ...
                  <p>
                    ...
                    protect the required environment and water these animals
                    need to survive, the federal government could intervene in
                    local water management and encroach upon private property
                    rights.
                  </p>
                  <div className="text-center">
                    <p className="emphasis-center-text">
                      "Our goal is to avoid the same fate the city of{" "}
                      <span className="emphasis-emphasis">Fort Stockton</span>{" "}
                      endured with their beloved{" "}
                      ...
                      , the rule of capture law will reign and leave future
                      generations without this valuable resource."
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      Spring and river flows are indicators of groundwater
                      levels in the watersheds of Val Verde County. We can use
                      our desired future spring and river flows to set water
                      management standards.
                    </p>
                    <p>
                      These standards, customized to each watershed, can aid the
                      sustainable management of our groundwater resources and
                      the protection of private property rights, recreational
                      values, and municipal water supplies.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <ScrollAnimation animateIn="fadeIn">
          <div className="row comanche-springs">
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
              ...
              <p>
                Once referred to as the “Spring City of Texas”, Fort Stockton is
                a prime example of the negative effects that come with the
                ...
                new well developments and excessive groundwater pumping for
                crops across the Belding Draw caused the springs to run dry.
              </p>
              <p>
                In 1954, the Texas Supreme Court upheld the “Rule of Capture”
                and ratified the right of irrigation owners west of town to pump
                as much water as they wished, even if it negatively impacted
                others use of groundwater. As a result, the Comanche Springs
                stopped flowing year-round, which had, for thousands of years,
                produced up to 35 million gallons a day. No water in the
                Comanche Springs meant no water for the irrigation canals. This
                led to the end of farming efforts for many.
              </p>
