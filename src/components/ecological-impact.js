      ...
      <div className="ecological-impact-section" id="ecological-impact">
        ...
        <div className="row comanche-springs">
          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
            ...
            <p>
              Once referred to as the "Spring City" of Texas, the over-pumping
              of a prominent water resource has happened before in Fort
              Stockton. Comanche Springs was one of the biggest springs in West
              Texas and the 8th largest in Texas.
            </p>
            <p>
              That came to an abrupt end in the 1950s, when new well
              developments and excessive groundwater pumping across the Belding
              Draw caused the springs to run dry. No water in the Comanche
              Springs meant no water for the irrigation canals. This led to the
              end of farming efforts for many.
            </p>
