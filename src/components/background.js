                ...
                <div className="row">
                      ...
                      <div className="background-body">
                        ...
                        <p>Large scale groundwater pumping could deplete our beloved rivers, creeks, and streams.
                          We are asking Val Verde County to consider: "Water. The Consequences?" of over pumping
                            our groundwater. <span><strong>The answer: "Misuse It and Lose It!"</strong></span>
                        </p>
                        <p>
                  ...
                  <div className="background-2 text-center col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mx-auto">
                    <ScrollAnimation animateIn="slideInRight" delay="0">
                      <img src={BackgroundOne} alt="" className="background-image-one" id="background-one-img" />
                    </ScrollAnimation>
                    <ScrollAnimation animateIn="slideInRight" delay="10">
                      <img src={BackgroundTwo} alt="" className="background-image-two" id="background-two-img" />
                    </ScrollAnimation>
                  </div>
                </div>
              </div>
