            ...
            <div className="background-1 col-xs-12 col-sm-12 col-md-12 col-lg-6">
              <ScrollAnimation animateIn="slideInLeft" delay="1">
                ...
                <p>
                  ...
                  Pecos River, Goodenough Spring, Cienegas Creek and San Felipe Creek. Fed by 
                  underground groundwater from the The Edwards-Trinity Aquifer, these water 
                  resources are all interconnected. If you impact one, you will affect another.
                </p>
                <p>
                  Did you know the lower Rio Grande gets about ⅓ of its water from springs located in Val 
                  Verde County? Widely considered as abundant and pure, our underground water has drawn 
                  attention from several large companies that look to exploit and export our water for 
                  commercial use. Unfortunately, there is no regulation in Texas for groundwater pumping 
                  due to the “Rule of Capture” law.  This law allows landowners to pump as much water as 
                  they see fit, without any liability for neighboring landowners and communities. As a 
                  result, this may deplete the supply of water altogether from our rivers, creeks and streams. 
                </p>
                <p>
                  We are asking Val Verde County to consider: “Water. The Consequences?” of over pumping 
                  our groundwater. 
                </p>
                <p className="background-callout">The answer: “Misuse It and Lose It!”</p>
                <p>
